  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) {
            final cubit = FeaturedBooksCubit(getIt.get<HomeRepo>());
        ...
        BlocProvider(
          create: (context) {
            final cubit = NewsetBooksCubit(getIt.get<HomeRepo>());
            cubit.fetchNewstBooks(); // Fetch books after Cubit creation
            return cubit;
          },
        ),
      ],
